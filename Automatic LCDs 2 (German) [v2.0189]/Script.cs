/* v:2.0189 (Fix Inventory ingot handling)
...
-Ғ);else{if(!ҹ)Κ=à.Ǧ(ȭ,à.ɞ*0.5f);else Κ=à.Ǧ(ȭ,à.ɞ*0.9f);}ґ[ȭ]=Κ;}ƴ.Ů();if(!ҹ)ƴ.ɱ(' ');if(!Җ){à.Ë(ƴ.ɱ(Κ).ɱ(' '));à.Ʋ(à.Ȑ(Ҏ
),1.0f,Ҍ+Ғ);à.ǖ(ƴ.Ů().ɱ(" / ").ɱ(à.Ȑ(Ê)));}else{à.ǖ(ƴ.ɱ(Κ));}}else{if(!Җ){à.Ë(ƴ.Ů().ɱ(ȭ).ɱ(':'));à.Ƶ(à.Ȑ(Ҏ),1.0f,ғ);}else
à.ǖ(ƴ.Ů().ɱ(ȭ));}}void Ҕ(string ȭ,double Ҏ,double ҍ,int Ê){if(Ê>0){if(!Җ){à.Ë(ƴ.Ů().ɱ(ȭ).ɱ(' '));à.Ʋ(à.Ȑ(Ҏ),0.51f);à.Ë(ƴ.
Ů().ɱ(" / ").ɱ(à.Ȑ(Ê)));à.Ƶ(ƴ.Ů().ɱ(" +").ɱ(à.Ȑ(ҍ)).ɱ(" ").ɱ(ğ.ǳ("I1")),1.0f);}else à.ǖ(ƴ.Ů().ɱ(ȭ));if(!ҹ)à.Ƹ(Math.Min(
...
bool ò){if(!ò){Ы=(Ɣ.ˮ.EndsWith("x")?"s":(Ɣ.ˮ.EndsWith("p")?"p":(Ɣ.ˮ.EndsWith("v")?"v":"n")));Ҿ=(Ɣ.ˮ.StartsWith(
"powersummary"));ѓ="a";ѿ="";if(Ɣ.ˮ.Contains("stored"))ѓ="s";else if(Ɣ.ˮ.Contains("in"))ѓ="i";else if(Ɣ.ˮ.Contains("out"))ѓ="o";ĕ=0;ӂ.Ů
();Ӂ.Ů();Ӏ.Ů();є.Ů();ҿ.Ů();}if(ѓ=="a"){if(ĕ==0){if(!ӂ.Ͼ("reactor",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}if(ĕ==1){if(!Ӂ.Ͼ(
"hydrogenengine",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}if(ĕ==2){if(!Ӏ.Ͼ("solarpanel",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}if(ĕ==3){if(!ҿ.Ͼ(
"windturbine",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}}else if(ĕ==0)ĕ=4;if(ĕ==4){if(!є.Ͼ("battery",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}int ф=ӂ.
Д();int у=Ӂ.Д();int т=Ӏ.Д();int с=є.Д();int р=ҿ.Д();if(ĕ==5){х=0;if(ф>0)х++;if(у>0)х++;if(т>0)х++;if(р>0)х++;if(с>0)х++;
if(х<1){à.ǖ(ğ.ǳ("P6"));return true;}if(Ɣ.ˑ.Count>0){if(Ɣ.ˑ[0].Ŕ.Length>0)ѿ=Ɣ.ˑ[0].Ŕ;}ĕ++;ò=false;}if(ѓ!="a"){if(!ѕ(є,(ѿ==
""?ğ.ǳ("P7"):ѿ),ѓ,Ы,ò))return false;return true;}string и=ğ.ǳ("P8");if(!Ҿ){if(ĕ==6){if(ф>0)if(!к(ӂ,(ѿ==""?ğ.ǳ("P9"):ѿ),Ы,ò
))return false;ĕ++;ò=false;}if(ĕ==7){if(у>0)if(!к(Ӂ,(ѿ==""?ğ.ǳ("P12"):ѿ),Ы,ò))return false;ĕ++;ò=false;}if(ĕ==8){if(т>0)
if(!к(Ӏ,(ѿ==""?ğ.ǳ("P10"):ѿ),Ы,ò))return false;ĕ++;ò=false;}if(ĕ==9){if(р>0)if(!к(ҿ,(ѿ==""?ğ.ǳ("P13"):ѿ),Ы,ò))return false
;ĕ++;ò=false;}if(ĕ==10){if(с>0)if(!ѕ(є,(ѿ==""?ğ.ǳ("P7"):ѿ),ѓ,Ы,ò))return false;ĕ++;ò=false;}}else{и=ğ.ǳ("P11");х=10;if(ĕ
==6)ĕ=11;}if(х==1)return true;if(!ò){ō.Ů();ō.Ж(ӂ);ō.Ж(Ӂ);ō.Ж(Ӏ);ō.Ж(ҿ);ō.Ж(є);}if(!к(ō,и,Ы,ò))return false;return true;}
void п(double ʞ,double ƍ){double з=(ƍ>0?ʞ/ƍ*100:0);switch(Ы){case"s":à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(з.ToString("F1")).ɱ("%"));break;case
...
Ů().ɱ(' ').ɱ(з.ToString("F1")).ɱ("%"));break;}}double о=0;double М=0,м=0;int л=0;bool к(π й,string и,string ʘ,bool ò){if(
!ò){М=0;м=0;л=0;}if(л==0){if(!ǉ.Ɂ(й.φ,ǉ.ȷ,ref о,ref о,ref М,ref м,ò))return false;л++;ò=false;}if(!ƫ.ʕ(50))return false;
double з=(м>0?М/м*100:0);à.Ë(и+": ");п(М*1000000,м*1000000);return true;}double ж=0,н=0,е=0,ц=0;double ј=0,ї=0;int і=0;ʐ ƴ=new
ʐ(100);bool ѕ(π є,string и,string ѓ,string ʘ,bool ò){if(!ò){ж=н=0;е=ц=0;ј=ї=0;і=0;}if(і==0){if(!ǉ.Ɇ(є.φ,ref е,ref ц,ref ж
,ref н,ref ј,ref ї,ò))return false;е*=1000000;ц*=1000000;ж*=1000000;н*=1000000;ј*=1000000;ї*=1000000;і++;ò=false;}double
ђ=(ї>0?ј/ї*100:0);double ё=(н>0?ж/н*100:0);double ѐ=(ц>0?е/ц*100:0);bool я=ѓ=="a";if(і==1){if(!ƫ.ʕ(50))return false;if(я)
{if(ʘ!="p"){à.Ë(ƴ.Ů().ɱ(и).ɱ(": "));à.Ƶ(ƴ.Ů().ɱ("(IN ").ɱ(à.Ȑ(е)).ɱ("W / OUT ").ɱ(à.Ȑ(ж)).ɱ("W)"));}else à.ǖ(ƴ.Ů().ɱ(и).ɱ
(": "));à.Ë(ƴ.Ů().ɱ("  ").ɱ(ğ.ǳ("P3")).ɱ(": "));}else à.Ë(ƴ.Ů().ɱ(и).ɱ(": "));if(я||ѓ=="s")switch(ʘ){case"s":à.Ƶ(ƴ.Ů().ɱ(
' ').ɱ(ђ.ToString("F1")).ɱ("%"));break;case"v":à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(ј)).ɱ("Wh / ").ɱ(à.Ȑ(ї)).ɱ("Wh"));break;case"p":à.Ƶ(ƴ.Ů().ɱ(
' ').ɱ(ђ.ToString("F1")).ɱ("%"));à.Ƹ(ђ);break;default:à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(ј)).ɱ("Wh / ").ɱ(à.Ȑ(ї)).ɱ("Wh"));à.ƿ(ђ,1.0f,à.Ʒ);à.Ƶ
(ƴ.Ů().ɱ(' ').ɱ(ђ.ToString("F1")).ɱ("%"));break;}if(ѓ=="s")return true;і++;ò=false;}if(і==2){if(!ƫ.ʕ(50))return false;if(
я)à.Ë(ƴ.Ů().ɱ("  ").ɱ(ğ.ǳ("P4")).ɱ(": "));if(я||ѓ=="o")switch(ʘ){case"s":à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ё.ToString("F1")).ɱ("%"));
break;case"v":à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(ж)).ɱ("W / ").ɱ(à.Ȑ(н)).ɱ("W"));break;case"p":à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ё.ToString("F1")).ɱ("%"));à.Ƹ(
ё);break;default:à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(ж)).ɱ("W / ").ɱ(à.Ȑ(н)).ɱ("W"));à.ƿ(ё,1.0f,à.Ʒ);à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ё.ToString("F1")).ɱ(
"%"));break;}if(ѓ=="o")return true;і++;ò=false;}if(!ƫ.ʕ(50))return false;if(я)à.Ë(ƴ.Ů().ɱ("  ").ɱ(ğ.ǳ("P5")).ɱ(": "));if(я
||ѓ=="i")switch(ʘ){case"s":à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ѐ.ToString("F1")).ɱ("%"));break;case"v":à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(е)).ɱ("W / ").ɱ(à.Ȑ(
ц)).ɱ("W"));break;case"p":à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ѐ.ToString("F1")).ɱ("%"));à.Ƹ(ѐ);break;default:à.Ƶ(ƴ.Ů().ɱ(à.Ȑ(е)).ɱ("W / ")
.ɱ(à.Ȑ(ц)).ɱ("W"));à.ƿ(ѐ,1.0f,à.Ʒ);à.Ƶ(ƴ.Ů().ɱ(' ').ɱ(ѐ.ToString("F1")).ɱ("%"));break;}return true;}}class ю:Ɯ{public ю()
{ɐ=7;ɓ="CmdPowerTime";}class э{public TimeSpan Ĥ=new TimeSpan(-1);public double г=-1;public double ь=0;}э ы=new э();π ъ;π
щ;public override void ɰ(){ъ=new π(ƫ,à.ŋ);щ=new π(ƫ,à.ŋ);}int ш=0;double ч=0;double д=0,Ш=0;double З=0,Ч=0,Ц=0;double Х=0
,Ф=0;int У=0;private bool Т(string ˬ,out TimeSpan С,out double ί,bool ò){MyResourceSourceComponent ȵ;
MyResourceSinkComponent ȟ;double П=ɑ;э О=ы;С=О.Ĥ;ί=О.г;if(!ò){ъ.Ů();щ.Ů();О.г=0;ш=0;ч=0;д=Ш=0;З=0;Ч=Ц=0;Х=Ф=0;У=0;}if(ш==0){if(!ъ.Ͼ("reactor",ˬ
,ò))return false;ò=false;ш++;}if(ш==1){for(;У<ъ.φ.Count;У++){if(!ƫ.ʕ(6))return false;IMyReactor Ý=ъ.φ[У]as IMyReactor;if(
Ý==null||!Ý.IsWorking)continue;if(Ý.Components.TryGet<MyResourceSourceComponent>(out ȵ)){д+=ȵ.CurrentOutputByType(à.ǉ.ȷ);
Ш+=ȵ.MaxOutputByType(à.ǉ.ȷ);}ч+=(double)Ý.GetInventory(0).CurrentMass;}ò=false;ш++;}if(ш==2){if(!щ.Ͼ("battery",ˬ,ò))
return false;ò=false;ш++;}if(ш==3){if(!ò)У=0;for(;У<щ.φ.Count;У++){if(!ƫ.ʕ(15))return false;IMyBatteryBlock Ý=щ.φ[У]as
IMyBatteryBlock;if(Ý==null||!Ý.IsWorking)continue;if(Ý.Components.TryGet<MyResourceSourceComponent>(out ȵ)){Ч=ȵ.CurrentOutputByType(à.ǉ
.ȷ);Ц=ȵ.MaxOutputByType(à.ǉ.ȷ);}if(Ý.Components.TryGet<MyResourceSinkComponent>(out ȟ)){Ч-=ȟ.CurrentInputByType(à.ǉ.ȷ);}
double Н=(Ч<0?(Ý.MaxStoredPower-Ý.CurrentStoredPower)/(-Ч/3600):0);if(Н>О.г)О.г=Н;if(Ý.ChargeMode==ChargeMode.Recharge)
continue;Х+=Ч;Ф+=Ц;З+=Ý.CurrentStoredPower;}ò=false;ш++;}double М=д+Х;if(М<=0)О.Ĥ=TimeSpan.FromSeconds(-1);else{double Л=О.Ĥ.
TotalSeconds;double К;double Й=(О.ь-ч)/П;if(д<=0)Й=Math.Min(М,Ш)/3600000;double И=0;if(Ф>0)И=Math.Min(М,Ф)/3600;if(Й<=0&&И<=0)К=-1;
else if(Й<=0)К=З/И;else if(И<=0)К=ч/Й;else{double Р=И;double Щ=(д<=0?М/3600:Й*М/д);К=З/Р+ч/Щ;}if(Л<=0||К<0)Л=К;else Л=(Л+К)/
2;try{О.Ĥ=TimeSpan.FromSeconds(Л);}catch{О.Ĥ=TimeSpan.FromSeconds(-1);}}О.ь=ч;ί=О.г;С=О.Ĥ;return true;}int ĕ=0;bool Τ=
false;bool ͷ=false;bool Ϊ=false;double г=0;TimeSpan Ȝ;int в=0,б=0,а=0;int Ǫ=0;int Я=0;public override bool Ƒ(bool ò){if(!ò){Τ
=Ɣ.ˮ.EndsWith("bar");ͷ=(Ɣ.ˮ[Ɣ.ˮ.Length-1]=='x');Ϊ=(Ɣ.ˮ[Ɣ.ˮ.Length-1]=='p');ĕ=0;в=б=а=Ǫ=0;Я=0;г=0;}if(ĕ==0){if(Ɣ.ˑ.Count>0
){for(;Я<Ɣ.ˑ.Count;Я++){if(!ƫ.ʕ(100))return false;Ɣ.ˑ[Я].ʟ();if(Ɣ.ˑ[Я].ʡ.Count<=0)continue;string Ŕ=Ɣ.ˑ[Я].ʡ[0];int.
TryParse(Ŕ,out Ǫ);if(Я==0)в=Ǫ;else if(Я==1)б=Ǫ;else if(Я==2)а=Ǫ;}}ĕ++;ò=false;}if(ĕ==1){if(!Т(Ɣ.ˬ,out Ȝ,out г,ò))return false;ĕ
++;ò=false;}if(!ƫ.ʕ(30))return false;double Ĥ=0;TimeSpan Ю;try{Ю=new TimeSpan(в,б,а);}catch{Ю=TimeSpan.FromSeconds(-1);}
string Ĵ;if(Ȝ.TotalSeconds>0||г<=0){if(!Τ)à.Ë(ğ.ǳ("PT1")+" ");Ĵ=à.ǉ.ȣ(Ȝ);Ĥ=Ȝ.TotalSeconds;}else{if(!Τ)à.Ë(ğ.ǳ("PT2")+" ");
TimeSpan Э;try{Э=TimeSpan.FromSeconds(г);}catch{Э=new TimeSpan(-1);}Ĵ=à.ǉ.ȣ(Э);if(Ю.TotalSeconds>=г)Ĥ=Ю.TotalSeconds-г;else Ĥ=0;
}if(Ю.Ticks<=0){à.Ƶ(Ĵ);return true;}double ʚ=Ĥ/Ю.TotalSeconds*100;if(ʚ>100)ʚ=100;if(Τ){à.Ƹ(ʚ);return true;}if(!ͷ&&!Ϊ){à.Ƶ
(Ĵ);à.ƿ(ʚ,1.0f,à.Ʒ);à.ǖ(' '+ʚ.ToString("0.0")+"%");}else if(Ϊ){à.Ƶ(ʚ.ToString("0.0")+"%");à.Ƹ(ʚ);}else à.Ƶ(ʚ.ToString(
"0.0")+"%");return true;}}class Ь:Ɯ{public Ь(){ɐ=7;ɓ="CmdPowerUsed";}ȸ ǉ;π ō;public override void ɰ(){ō=new π(ƫ,à.ŋ);ǉ=à.ǉ;}
string Ы;string Ъ;string ϫ;void п(double ʞ,double ƍ){double з=(ƍ>0?ʞ/ƍ*100:0);switch(Ы){case"s":à.Ƶ(з.ToString("0.0")+"%",1.0f
);break;case"v":à.Ƶ(à.Ȑ(ʞ)+"W / "+à.Ȑ(ƍ)+"W",1.0f);break;case"c":à.Ƶ(à.Ȑ(ʞ)+"W",1.0f);break;case"p":à.Ƶ(з.ToString("0.0")
+"%",1.0f);à.Ƹ(з);break;default:à.Ƶ(à.Ȑ(ʞ)+"W / "+à.Ȑ(ƍ)+"W");à.ƿ(з,1.0f,à.Ʒ);à.Ƶ(' '+з.ToString("0.0")+"%");break;}}
double ȿ=0,Ⱦ=0;int ѳ=0;int ĕ=0;Ѯ Ѳ=new Ѯ();public override bool Ƒ(bool ò){if(!ò){Ы=(Ɣ.ˮ.EndsWith("x")?"s":(Ɣ.ˮ.EndsWith(
"usedp")||Ɣ.ˮ.EndsWith("topp")?"p":(Ɣ.ˮ.EndsWith("v")?"v":(Ɣ.ˮ.EndsWith("c")?"c":"n"))));Ъ=(Ɣ.ˮ.Contains("top")?"top":"");ϫ=(Ɣ.
ˑ.Count>0?Ɣ.ˑ[0].Ŕ:ğ.ǳ("PU1"));ȿ=Ⱦ=0;ĕ=0;ѳ=0;ō.Ů();Ѳ.Y();}if(ĕ==0){if(!ō.ϥ(Ɣ.ˬ,ò))return false;ò=false;ĕ++;}
MyResourceSinkComponent ȟ;MyResourceSourceComponent ȵ;switch(Ъ){case"top":if(ĕ==1){for(;ѳ<ō.φ.Count;ѳ++){if(!ƫ.ʕ(20))return false;
IMyTerminalBlock Ý=ō.φ[ѳ];if(Ý.Components.TryGet<MyResourceSinkComponent>(out ȟ)){ListReader<MyDefinitionId>ȝ=ȟ.AcceptedResources;if(ȝ.
IndexOf(ǉ.ȷ)<0)continue;ȿ=ȟ.CurrentInputByType(ǉ.ȷ)*1000000;}else continue;Ѳ.v(ȿ,Ý);}ò=false;ĕ++;}if(Ѳ.j()<=0){à.ǖ(
"PowerUsedTop: "+ğ.ǳ("D2"));return true;}int Ĺ=10;if(Ɣ.ˑ.Count>0)if(!int.TryParse(ϫ,out Ĺ)){Ĺ=10;}if(Ĺ>Ѳ.j())Ĺ=Ѳ.j();if(ĕ==2){if(!ò){ѳ=Ѳ
.j()-1;Ѳ.Z();}for(;ѳ>=Ѳ.j()-Ĺ;ѳ--){if(!ƫ.ʕ(30))return false;IMyTerminalBlock Ý=Ѳ.b(ѳ);string ƕ=à.Ǧ(Ý.CustomName,à.ɞ*0.4f)
;if(Ý.Components.TryGet<MyResourceSinkComponent>(out ȟ)){ȿ=ȟ.CurrentInputByType(ǉ.ȷ)*1000000;Ⱦ=ȟ.MaxRequiredInputByType(ǉ
.ȷ)*1000000;var ѯ=(Ý as IMyRadioAntenna);if(ѯ!=null)Ⱦ*=ѯ.Radius/500;}à.Ë(ƕ+" ");п(ȿ,Ⱦ);}}break;default:for(;ѳ<ō.φ.Count;ѳ
++){if(!ƫ.ʕ(10))return false;double Ѱ;IMyTerminalBlock Ý=ō.φ[ѳ];if(Ý.Components.TryGet<MyResourceSinkComponent>(out ȟ)){
ListReader<MyDefinitionId>ȝ=ȟ.AcceptedResources;if(ȝ.IndexOf(ǉ.ȷ)<0)continue;Ѱ=ȟ.CurrentInputByType(ǉ.ȷ);Ⱦ+=ȟ.
MaxRequiredInputByType(ǉ.ȷ);var ѯ=(Ý as IMyRadioAntenna);if(ѯ!=null){Ⱦ*=ѯ.Radius/500;}}else continue;if(Ý.Components.TryGet<
MyResourceSourceComponent>(out ȵ)&&(Ý as IMyBatteryBlock!=null)){Ѱ-=ȵ.CurrentOutputByType(ǉ.ȷ);if(Ѱ<=0)continue;}ȿ+=Ѱ;}à.Ë(ϫ);п(ȿ*1000000,Ⱦ*
1000000);break;}return true;}public class Ѯ{List<KeyValuePair<double,IMyTerminalBlock>>ѭ=new List<KeyValuePair<double,
IMyTerminalBlock>>();public void v(double ѱ,IMyTerminalBlock Ý){ѭ.Add(new KeyValuePair<double,IMyTerminalBlock>(ѱ,Ý));}public int j(){
return ѭ.Count;}public IMyTerminalBlock b(int a){return ѭ[a].Value;}public void Y(){ѭ.Clear();}public void Z(){ѭ.Sort((Ϧ,Ѿ)=>(
Ϧ.Key.CompareTo(Ѿ.Key)));}}}class ѽ:Ɯ{π ō;public ѽ(){ɐ=1;ɓ="CmdProp";}public override void ɰ(){ō=new π(ƫ,à.ŋ);}int ĕ=0;
int ѳ=0;bool Ѽ=false;string ѻ=null;string Ѻ=null;string ѹ=null;string Ѹ=null;public override bool Ƒ(bool ò){if(!ò){Ѽ=Ɣ.ˮ.
StartsWith("props");ѻ=Ѻ=ѹ=Ѹ=null;ѳ=0;ĕ=0;}if(Ɣ.ˑ.Count<1){à.ǖ(Ɣ.ˮ+": "+"Missing property name.");return true;}if(ĕ==0){if(!ò)ō.Ů()
;if(!ō.ϥ(Ɣ.ˬ,ò))return false;ѷ();ĕ++;ò=false;}if(ĕ==1){int Ĺ=ō.Д();if(Ĺ==0){à.ǖ(Ɣ.ˮ+": "+"No blocks found.");return true;
}for(;ѳ<Ĺ;ѳ++){if(!ƫ.ʕ(50))return false;IMyTerminalBlock Ý=ō.φ[ѳ];if(Ý.GetProperty(ѻ)!=null){if(Ѻ==null){string ϫ=à.Ǧ(Ý.
CustomName,à.ɞ*0.7f);à.Ë(ϫ);}else à.Ë(Ѻ);à.Ƶ(Ѷ(Ý,ѻ,ѹ,Ѹ));if(!Ѽ)return true;}}}return true;}void ѷ(){ѻ=Ɣ.ˑ[0].Ŕ;if(Ɣ.ˑ.Count>1){if(
!Ѽ)Ѻ=Ɣ.ˑ[1].Ŕ;else ѹ=Ɣ.ˑ[1].Ŕ;if(Ɣ.ˑ.Count>2){if(!Ѽ)ѹ=Ɣ.ˑ[2].Ŕ;else Ѹ=Ɣ.ˑ[2].Ŕ;if(Ɣ.ˑ.Count>3&&!Ѽ)Ѹ=Ɣ.ˑ[3].Ŕ;}}}string Ѷ(
IMyTerminalBlock Ý,string ѵ,string Ѵ=null,string Ѭ=null){return(Ý.GetValue<bool>(ѵ)?(Ѵ!=null?Ѵ:ğ.ǳ("W9")):(Ѭ!=null?Ѭ:ğ.ǳ("W1")));}}class
Ѣ:Ɯ{public Ѣ(){ɐ=5;ɓ="CmdShipCtrl";}π ō;public override void ɰ(){ō=new π(ƫ,à.ŋ);}public override bool Ƒ(bool ò){if(!ò)ō.Ů
();if(!ō.Ͼ("shipctrl",Ɣ.ˬ,ò))return false;if(ō.Д()<=0){if(Ɣ.ˬ!=""&&Ɣ.ˬ!="*")à.ǖ(Ɣ.ˮ+": "+ğ.ǳ("SC1")+" ("+Ɣ.ˬ+")");else à.
ǖ(Ɣ.ˮ+": "+ğ.ǳ("SC1"));return true;}if(Ɣ.ˮ.StartsWith("damp")){bool а=(ō.φ[0]as IMyShipController).DampenersOverride;à.Ë(
ğ.ǳ("SCD"));à.Ƶ(а?"ON":"OFF");}else{bool а=(ō.φ[0]as IMyShipController).IsUnderControl;à.Ë(ğ.ǳ("SCO"));à.Ƶ(а?"YES":"NO");
}return true;}}class Ѡ:Ɯ{public Ѡ(){ɐ=1;ɓ="CmdShipMass";}public override bool Ƒ(bool ò){bool џ=Ɣ.ˮ.EndsWith("base");
double ʛ=0;if(Ɣ.ˬ!="")double.TryParse(Ɣ.ˬ.Trim(),out ʛ);int ў=Ɣ.ˑ.Count;if(ў>0){string ѡ=Ɣ.ˑ[0].Ŕ.Trim();char њ=' ';if(ѡ.
Length>0)њ=Char.ToLower(ѡ[0]);int ѝ="kmgtpezy".IndexOf(њ);if(ѝ>=0)ʛ*=Math.Pow(1000.0,ѝ);}double ɺ=(џ?à.ǈ.ɸ:à.ǈ.ɹ);if(!џ)à.Ë(ğ.
ǳ("SM1")+" ");else à.Ë(ğ.ǳ("SM2")+" ");à.Ƶ(à.ȏ(ɺ,true,'k')+" ");if(ʛ>0)à.Ƹ(ɺ/ʛ*100);return true;}}class ќ:Ɯ{public ќ(){ɐ=
0.5;ɓ="CmdSpeed";}public override bool Ƒ(bool ò){double ʛ=0;double ћ=1;string њ="m/s";if(Ɣ.ˮ.Contains("kmh")){ћ=3.6;њ=
"km/h";}else if(Ɣ.ˮ.Contains("mph")){ћ=2.23694;њ="mph";}if(Ɣ.ˬ!="")double.TryParse(Ɣ.ˬ.Trim(),out ʛ);à.Ë(ğ.ǳ("S1")+" ");à.Ƶ((à
.ǈ.ʂ*ћ).ToString("F1")+" "+њ+" ");if(ʛ>0)à.Ƹ(à.ǈ.ʂ/ʛ*100);return true;}}class љ:Ɯ{public љ(){ɐ=1;ɓ="CmdStopTask";}public
override bool Ƒ(bool ò){double ѣ=0;if(Ɣ.ˮ.Contains("best"))ѣ=à.ǈ.ʂ/à.ǈ.ʉ;else ѣ=à.ǈ.ʂ/à.ǈ.ɻ;double ѧ=à.ǈ.ʂ/2*ѣ;if(Ɣ.ˮ.Contains(
"time")){à.Ë(ğ.ǳ("ST"));if(double.IsNaN(ѣ)){à.Ƶ("N/A");return true;}string Ĵ="";try{TimeSpan Ά=TimeSpan.FromSeconds(ѣ);if((int
)Ά.TotalDays>0)Ĵ=" > 24h";else{if(Ά.Hours>0)Ĵ=Ά.Hours+"h ";if(Ά.Minutes>0||Ĵ!="")Ĵ+=Ά.Minutes+"m ";Ĵ+=Ά.Seconds+"s";}}
catch{Ĵ="N/A";}à.Ƶ(Ĵ);return true;}à.Ë(ğ.ǳ("SD"));if(!double.IsNaN(ѧ)&&!double.IsInfinity(ѧ))à.Ƶ(à.Ȑ(ѧ)+"m ");else à.Ƶ("N/A")
;return true;}}class ѫ:Ɯ{ȸ ǉ;π ō;public ѫ(){ɐ=2;ɓ="CmdTanks";}public override void ɰ(){ǉ=à.ǉ;ō=new π(ƫ,à.ŋ);}int ĕ=0;char
Ы='n';string Ѫ;double ѩ=0;double Ѩ=0;double ƾ;bool Τ=false;public override bool Ƒ(bool ò){List<ʮ>ˑ=Ɣ.ˑ;if(ˑ.Count==0){à.ǖ
(ğ.ǳ("T4"));return true;}if(!ò){Ы=(Ɣ.ˮ.EndsWith("x")?'s':(Ɣ.ˮ.EndsWith("p")?'p':(Ɣ.ˮ.EndsWith("v")?'v':'n')));Τ=Ɣ.ˮ.
EndsWith("bar");ĕ=0;if(Ѫ==null){Ѫ=ˑ[0].Ŕ.Trim();Ѫ=char.ToUpper(Ѫ[0])+Ѫ.Substring(1).ToLower();}ō.Ů();ѩ=0;Ѩ=0;}if(ĕ==0){if(!ō.Ͼ(
"oxytank",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}if(ĕ==1){if(!ō.Ͼ("hydrogenengine",Ɣ.ˬ,ò))return false;ò=false;ĕ++;}if(ĕ==2){if(!ǉ.Ȓ(ō.
φ,Ѫ,ref ѩ,ref Ѩ,ò))return false;ò=false;ĕ++;}if(Ѩ==0){à.ǖ(String.Format(ğ.ǳ("T5"),Ѫ));return true;}ƾ=ѩ/Ѩ*100;if(Τ){à.Ƹ(ƾ)
;return true;}à.Ë(Ѫ);switch(Ы){case's':à.Ƶ(' '+à.ȇ(ƾ)+"%");break;case'v':à.Ƶ(à.Ȑ(ѩ)+"L / "+à.Ȑ(Ѩ)+"L");break;case'p':à.Ƶ(
' '+à.ȇ(ƾ)+"%");à.Ƹ(ƾ);break;default:à.Ƶ(à.Ȑ(ѩ)+"L / "+à.Ȑ(Ѩ)+"L");à.ƿ(ƾ,1.0f,à.Ʒ);à.Ƶ(' '+ƾ.ToString("0.0")+"%");break;}
return true;}}class Ѧ{ɬ à=null;public string L="Debug";public float ѥ=1.0f;public List<ʐ>ŧ=new List<ʐ>();public int Ų=0;public
float Ѥ=0;public Ѧ(ɬ V){à=V;ŧ.Add(new ʐ());}public void ÿ(string Ĵ){ŧ[Ų].ɱ(Ĵ);}public void ÿ(ʐ Ŧ){ŧ[Ų].ɱ(Ŧ);}public void ť(){
ŧ.Add(new ʐ());Ų++;Ѥ=0;}public void ť(string Ť){ŧ[Ų].ɱ(Ť);ť();}public void ţ(List<ʐ>Ţ){if(ŧ[Ų].ʎ==0)ŧ.RemoveAt(Ų);else Ų
++;ŧ.AddList(Ţ);Ų+=Ţ.Count-1;ť();}public List<ʐ>ś(){if(ŧ[Ų].ʎ==0)return ŧ.GetRange(0,Ų);else return ŧ;}public void š(
string Š,string G=""){string[]ŧ=Š.Split('\n');for(int X=0;X<ŧ.Length;X++)ť(G+ŧ[X]);}public void Ş(){ŧ.Clear();ť();Ų=0;}public
int ŝ(){return Ų+(ŧ[Ų].ʎ>0?1:0);}public string Ŝ(){return String.Join("\n",ŧ);}public void ś(List<ʐ>Ś,int ļ,int ř){int Ř=ļ+
ř;int ľ=ŝ();if(Ř>ľ)Ř=ľ;for(int X=ļ;X<Ř;X++)Ś.Add(ŧ[X]);}}class ş{ɬ à=null;public float Ũ=1.0f;public int Ÿ=17;public int
Ŷ=0;int ŵ=1;int Ŵ=1;public List<Ѧ>ų=new List<Ѧ>();public int Ų=0;public ş(ɬ V){à=V;}public void ű(int Ĺ){Ŵ=Ĺ;}public void
Ű(){Ÿ=(int)Math.Floor(ɬ.ɩ*Ũ*Ŵ/ɬ.ɧ);}public void ů(Ѧ Ĵ){ų.Add(Ĵ);}public void Ů(){ų.Clear();}public int ŝ(){int Ĺ=0;
foreach(var Ĵ in ų){Ĺ+=Ĵ.ŝ();}return Ĺ;}ʐ ŭ=new ʐ(256);public ʐ Ŝ(){ŭ.Ů();int Ĺ=ų.Count;for(int X=0;X<Ĺ-1;X++){ŭ.ɱ(ų[X].Ŝ());ŭ.
ɱ("\n");}if(Ĺ>0)ŭ.ɱ(ų[Ĺ-1].Ŝ());return ŭ;}List<ʐ>Ŭ=new List<ʐ>(20);public ʐ ū(int Ū=0){ŭ.Ů();Ŭ.Clear();if(Ŵ<=0)return ŭ;
int ũ=ų.Count;int ŗ=0;int Ń=(Ÿ/Ŵ);int Ĳ=(Ū*Ń);int Ł=Ŷ+Ĳ;int ŀ=Ł+Ń;bool Ŀ=false;for(int X=0;X<ũ;X++){Ѧ Ĵ=ų[X];int ľ=Ĵ.ŝ();
int Ľ=ŗ;ŗ+=ľ;if(!Ŀ&&ŗ>Ł){int ļ=Ł-Ľ;if(ŗ>=ŀ){Ĵ.ś(Ŭ,ļ,ŀ-Ľ-ļ);break;}Ŀ=true;Ĵ.ś(Ŭ,ļ,ľ);continue;}if(Ŀ){if(ŗ>=ŀ){Ĵ.ś(Ŭ,0,ŀ-Ľ);
break;}Ĵ.ś(Ŭ,0,ľ);}}int Ĺ=Ŭ.Count;for(int X=0;X<Ĺ-1;X++){ŭ.ɱ(Ŭ[X]);ŭ.ɱ("\n");}if(Ĺ>0)ŭ.ɱ(Ŭ[Ĺ-1]);return ŭ;}public bool ł(int
Ĺ=-1){if(Ĺ<=0)Ĺ=à.ɯ;if(Ŷ-Ĺ<=0){Ŷ=0;return true;}Ŷ-=Ĺ;return false;}public bool ĺ(int Ĺ=-1){if(Ĺ<=0)Ĺ=à.ɯ;int ĸ=ŝ();if(Ŷ+Ĺ
+Ÿ>=ĸ){Ŷ=Math.Max(ĸ-Ÿ,0);return true;}Ŷ+=Ĺ;return false;}public int ķ=0;public void Ķ(){if(ķ>0){ķ--;return;}if(ŝ()<=Ÿ){Ŷ=
0;ŵ=1;return;}if(ŵ>0){if(ĺ()){ŵ=-1;ķ=2;}}else{if(ł()){ŵ=1;ķ=2;}}}}class ĵ:Ɯ{public ĵ(){ɐ=1;ɓ="CmdTextLCD";}public
override bool Ƒ(bool ò){string Ĵ="";if(Ɣ.ˬ!=""&&Ɣ.ˬ!="*"){IMyTextPanel ĳ=à.Ǉ.GetBlockWithName(Ɣ.ˬ)as IMyTextPanel;if(ĳ==null){à.
ǖ("TextLCD: "+ğ.ǳ("T1")+Ɣ.ˬ);return true;}Ĵ=ĳ.GetText();}else{à.ǖ("TextLCD:"+ğ.ǳ("T2"));return true;}if(Ĵ.Length==0)
return true;à.Ǖ(Ĵ);return true;}}class Ļ:Ɯ{public Ļ(){ɐ=5;ɓ="CmdWorking";}π ō;public override void ɰ(){ō=new π(ƫ,à.ŋ);}int ĕ=0
;int Ŗ=0;bool ŕ;public override bool Ƒ(bool ò){if(!ò){ĕ=0;ŕ=(Ɣ.ˮ=="workingx");Ŗ=0;}if(Ɣ.ˑ.Count==0){if(ĕ==0){if(!ò)ō.Ů();
if(!ō.ϥ(Ɣ.ˬ,ò))return false;ĕ++;ò=false;}if(!ƙ(ō,ŕ,"",ò))return false;return true;}for(;Ŗ<Ɣ.ˑ.Count;Ŗ++){ʮ Ŕ=Ɣ.ˑ[Ŗ];if(!ò)
Ŕ.ʟ();if(!Ŏ(Ŕ,ò))return false;ò=false;}return true;}int œ=0;int Œ=0;string[]ő;string Ő;string ŏ;bool Ŏ(ʮ Ŕ,bool ò){if(!ò)
{œ=0;Œ=0;}for(;Œ<Ŕ.ʡ.Count;Œ++){if(œ==0){if(!ò){if(string.IsNullOrEmpty(Ŕ.ʡ[Œ]))continue;ō.Ů();ő=Ŕ.ʡ[Œ].Split(':');Ő=ő[0]
;ŏ=(ő.Length>1?ő[1]:"");}if(!string.IsNullOrEmpty(Ő)){if(!ō.Ͼ(Ő,Ɣ.ˬ,ò))return false;}else{if(!ō.ϥ(Ɣ.ˬ,ò))return false;}œ
++;ò=false;}if(!ƙ(ō,ŕ,ŏ,ò))return false;œ=0;ò=false;}return true;}string Ō(IMyTerminalBlock Ý){Г ŋ=à.ŋ;if(!Ý.IsWorking)
return ğ.ǳ("W1");IMyProductionBlock Ŋ=Ý as IMyProductionBlock;if(Ŋ!=null)if(Ŋ.IsProducing)return ğ.ǳ("W2");else return ğ.ǳ(
"W3");IMyAirVent ŉ=Ý as IMyAirVent;if(ŉ!=null){if(ŉ.CanPressurize)return(ŉ.GetOxygenLevel()*100).ToString("F1")+"%";else
return ğ.ǳ("W4");}IMyGasTank ň=Ý as IMyGasTank;if(ň!=null)return(ň.FilledRatio*100).ToString("F1")+"%";IMyBatteryBlock Ň=Ý as
IMyBatteryBlock;if(Ň!=null)return ŋ.ϲ(Ň);IMyJumpDrive ņ=Ý as IMyJumpDrive;if(ņ!=null)return ŋ.ϧ(ņ).ToString("0.0")+"%";IMyLandingGear Ņ
=Ý as IMyLandingGear;if(Ņ!=null){switch((int)Ņ.LockMode){case 0:return ğ.ǳ("W8");case 1:return ğ.ǳ("W10");case 2:return ğ
.ǳ("W7");}}IMyDoor ń=Ý as IMyDoor;if(ń!=null){if(ń.Status==DoorStatus.Open)return ğ.ǳ("W5");return ğ.ǳ("W6");}
IMyShipConnector ŷ=Ý as IMyShipConnector;if(ŷ!=null){if(ŷ.Status==MyShipConnectorStatus.Unconnected)return ğ.ǳ("W8");if(ŷ.Status==
MyShipConnectorStatus.Connected)return ğ.ǳ("W7");else return ğ.ǳ("W10");}IMyLaserAntenna Ź=Ý as IMyLaserAntenna;if(Ź!=null)return ŋ.ϩ(Ź);
IMyRadioAntenna ƪ=Ý as IMyRadioAntenna;if(ƪ!=null)return à.Ȑ(ƪ.Radius)+"m";IMyBeacon Ɲ=Ý as IMyBeacon;if(Ɲ!=null)return à.Ȑ(Ɲ.Radius)+
"m";IMyThrust ƛ=Ý as IMyThrust;if(ƛ!=null&&ƛ.ThrustOverride>0)return à.Ȑ(ƛ.ThrustOverride)+"N";return ğ.ǳ("W9");}int ƚ=0;
bool ƙ(π Ñ,bool Ƙ,string Ɨ,bool ò){if(!ò)ƚ=0;for(;ƚ<Ñ.Д();ƚ++){if(!ƫ.ʕ(20))return false;IMyTerminalBlock Ý=Ñ.φ[ƚ];string Ɩ=(
Ƙ?(Ý.IsWorking?ğ.ǳ("W9"):ğ.ǳ("W1")):Ō(Ý));if(!string.IsNullOrEmpty(Ɨ)&&String.Compare(Ɩ,Ɨ,true)!=0)continue;if(Ƙ)Ɩ=Ō(Ý);
string ƕ=Ý.CustomName;ƕ=à.Ǧ(ƕ,à.ɞ*0.7f);à.Ë(ƕ);à.Ƶ(Ɩ);}return true;}}class Ɯ:ɔ{public Ѧ Ĵ=null;protected Ͱ Ɣ;protected ɬ à;
protected Ē Ğ;protected ǫ ğ;public Ɯ(){ɐ=3600;ɓ="CommandTask";}public void Ɠ(Ē Ĝ,Ͱ ƒ){Ğ=Ĝ;à=Ğ.à;Ɣ=ƒ;ğ=à.ğ;}public virtual bool Ƒ(
bool ò){à.ǖ(ğ.ǳ("UC")+": '"+Ɣ.ˤ+"'");return true;}public override bool ɮ(bool ò){Ĵ=à.Ǚ(Ĵ,Ğ.o);if(!ò)à.Ş();return Ƒ(ò);}}
class Ɛ{Dictionary<string,string>ƞ=new Dictionary<string,string>(StringComparer.InvariantCultureIgnoreCase){{"ingot","ingot"}
,{"ore","ore"},{"component","component"},{"tool","physicalgunobject"},{"ammo","ammomagazine"},{"oxygen",
"oxygencontainerobject"},{"gas","gascontainerobject"}};Ț ƫ;ɬ à;Ɔ Ʃ;Ɔ ƨ;Ɔ Ƨ;Ï Ʀ;bool ƥ;public Ɔ Ƥ;public Ɛ(Ț ƣ,ɬ V,int B=20){Ʃ=new Ɔ();ƨ=new Ɔ()
;Ƨ=new Ɔ();ƥ=false;Ƥ=new Ɔ();ƫ=ƣ;à=V;Ʀ=à.Ʀ;}public void Ů(){Ƨ.Y();ƨ.Y();Ʃ.Y();ƥ=false;Ƥ.Y();}public void Ƣ(string ơ,bool
ƌ=false,int Ǝ=1,int ƍ=-1){if(string.IsNullOrEmpty(ơ)){ƥ=true;return;}string[]Ơ=ơ.Split(' ');string Â="";Ə ƀ=new Ə(ƌ,Ǝ,ƍ);
if(Ơ.Length==2){if(!ƞ.TryGetValue(Ơ[1],out Â))Â=Ơ[1];}string Ã=Ơ[0];if(ƞ.TryGetValue(Ã,out ƀ.Â)){ƨ.v(ƀ.Â,ƀ);return;}à.Ǽ(
ref Ã,ref Â);if(string.IsNullOrEmpty(Â)){ƀ.Ã=Ã;Ʃ.v(ƀ.Ã,ƀ);return;}ƀ.Ã=Ã;ƀ.Â=Â;Ƨ.v(Ã+' '+Â,ƀ);}public Ə Ɵ(string Å,string Ã,
string Â){Ə ƀ;ƀ=Ƨ.f(Å);if(ƀ!=null)return ƀ;ƀ=Ʃ.f(Ã);if(ƀ!=null)return ƀ;ƀ=ƨ.f(Â);if(ƀ!=null)return ƀ;return null;}public bool
ź(string Å,string Ã,string Â){Ə ƀ;bool ƃ=false;ƀ=ƨ.f(Â);if(ƀ!=null){if(ƀ.ƌ)return true;ƃ=true;}ƀ=Ʃ.f(Ã);if(ƀ!=null){if(ƀ.
ƌ)return true;ƃ=true;}ƀ=Ƨ.f(Å);if(ƀ!=null){if(ƀ.ƌ)return true;ƃ=true;}return!(ƥ||ƃ);}public Ə Ƃ(string Å,string Ã,string
Â){Ə ſ=new Ə();Ə ƀ=Ɵ(Å,Ã,Â);if(ƀ!=null){ſ.Ǝ=ƀ.Ǝ;ſ.ƍ=ƀ.ƍ;}ſ.Ã=Ã;ſ.Â=Â;Ƥ.v(Å,ſ);return ſ;}public Ə Ɓ(string Å,string Ã,
string Â){Ə ſ=Ƥ.f(Å);if(ſ==null)ſ=Ƃ(Å,Ã,Â);return ſ;}int ž=0;List<Ə>Ž;public List<Ə>ż(string Â,bool ò,Func<Ə,bool>Ż=null){if(!
ò){Ž=new List<Ə>();ž=0;}for(;ž<Ƥ.j();ž++){if(!ƫ.ʕ(5))return null;Ə ƀ=Ƥ.b(ž);if(ź(ƀ.Ã+' '+ƀ.Â,ƀ.Ã,ƀ.Â))continue;if((string
.Compare(ƀ.Â,Â,true)==0)&&(Ż==null||Ż(ƀ)))Ž.Add(ƀ);}return Ž;}int Ƅ=0;public bool Ɖ(bool ò){if(!ò){Ƅ=0;}for(;Ƅ<Ʀ.w.Count;
Ƅ++){if(!ƫ.ʕ(10))return false;È k=Ʀ.Î[Ʀ.w[Ƅ]];if(!k.Æ)continue;string Å=k.Á+' '+k.Ò;if(ź(Å,k.Á,k.Ò))continue;Ə ſ=Ɓ(Å,k.Á,
k.Ò);if(ſ.ƍ==-1)ſ.ƍ=k.ë;}return true;}}class Ə{public int Ǝ;public int ƍ;public string Ã="";public string Â="";public
bool ƌ;public double Ƌ;public Ə(bool Ɗ=false,int ƈ=1,int Ƈ=-1){Ǝ=ƈ;ƌ=Ɗ;ƍ=Ƈ;}}class Ɔ{Dictionary<string,Ə>ƅ=new Dictionary<
string,Ə>(StringComparer.InvariantCultureIgnoreCase);List<string>w=new List<string>();public void v(string e,Ə k){if(!ƅ.
ContainsKey(e)){w.Add(e);ƅ.Add(e,k);}}public int j(){return ƅ.Count;}public Ə f(string e){if(ƅ.ContainsKey(e))return ƅ[e];return
null;}public Ə b(int a){return ƅ[w[a]];}public void Y(){w.Clear();ƅ.Clear();}public void Z(){w.Sort();}}class Ï{public
Dictionary<string,È>Î=new Dictionary<string,È>(StringComparer.InvariantCultureIgnoreCase);Dictionary<string,È>Í=new Dictionary<
string,È>(StringComparer.InvariantCultureIgnoreCase);public List<string>w=new List<string>();public Dictionary<string,È>Ì=new
Dictionary<string,È>(StringComparer.InvariantCultureIgnoreCase);public void Ë(string Ã,string Â,int Ê,string Ð,string É,string Ç,
bool Æ){if(Â=="Ammo")Â="AmmoMagazine";else if(Â=="Tool")Â="PhysicalGunObject";string Å=Ã+' '+Â;È k=new È(Ã,Â,Ê,Ð,É,Æ);Î.Add(
Å,k);if(!Í.ContainsKey(Ã))Í.Add(Ã,k);if(É!="")Ì.Add(É,k);if(Ç!="")Ì.Add(Ç,k);w.Add(Å);}public È Ä(string Ã="",string Â=""
){if(Î.ContainsKey(Ã+" "+Â))return Î[Ã+" "+Â];if(string.IsNullOrEmpty(Â)){È k=null;Í.TryGetValue(Ã,out k);return k;}if(
string.IsNullOrEmpty(Ã))for(int X=0;X<Î.Count;X++){È k=Î[w[X]];if(string.Compare(Â,k.Ò,true)==0)return k;}return null;}}class
È{public string Á;public string Ò;public int ë;public string é;public string è;public bool Æ;public È(string ç,string æ,
int å=0,string ä="",string ã="",bool â=true){Á=ç;Ò=æ;ë=å;é=ä;è=ã;Æ=â;}}class á{ɬ à=null;public µ ß=new µ();public ş Þ;
public IMyTerminalBlock Ý;public IMyTextSurface Ü;public int Û=0;public int Ú=0;public string Ù="";public string Ø="";public
bool Ö=true;public IMyTextSurface Õ=>(Ó?Ü:Ý as IMyTextSurface);public int Ô=>(Ó?(à.ǚ(Ý)?0:1):ß.j());public bool Ó=false;
public á(ɬ V,string A){à=V;Ø=A;}public á(ɬ V,string A,IMyTerminalBlock U,IMyTextSurface C,int S){à=V;Ø=A;Ý=U;Ü=C;Û=S;Ó=true;}
public bool R(){return Þ.ŝ()>Þ.Ÿ||Þ.Ŷ!=0;}float Q=1.0f;bool P=false;public float O(){if(P)return Q;P=true;return Q;}float W=
1.0f;bool N=false;public float K(){if(N)return W;N=true;return W;}bool J=false;public void I(){if(J)return;if(!Ó){ß.Z();Ý=ß.
b(0);}int H=Ý.CustomName.IndexOf("!MARGIN:");if(H<0||H+8>=Ý.CustomName.Length){Ú=1;Ù=" ";}else{string G=Ý.CustomName.
Substring(H+8);int F=G.IndexOf(" ");if(F>=0)G=G.Substring(0,F);if(!int.TryParse(G,out Ú))Ú=1;Ù=new String(' ',Ú);}if(Ý.CustomName
.Contains("!NOSCROLL"))Ö=false;else Ö=true;J=true;}public void E(ş D=null){if(Þ==null||Ý==null)return;if(D==null)D=Þ;if(!
...
public int ý=0;public ɬ à;public Ⱥ ß=new Ⱥ();π ü;π û;Dictionary<á,Ē>ú=new Dictionary<á,Ē>();public Dictionary<IMyTextSurface,á
>ù=new Dictionary<IMyTextSurface,á>();public bool ø=false;Ϻ ö=null;public þ(ɬ V){ɐ=5;à=V;ɓ="ProcessPanels";}public
override void ɰ(){ü=new π(ƫ,à.ŋ);û=new π(ƫ,à.ŋ);ö=new Ϻ(à,this);}int õ=0;bool ó(bool ò){if(!ò)õ=0;if(õ==0){if(!ü.ϥ(à.ɦ,ò))return
...
while(ć<ü.Д()){if(!ƫ.ʕ(20))return false;IMyTerminalBlock Ý=(ü.φ[ć]as IMyTerminalBlock);if(Ý==null||!Ý.IsWorking){ü.φ.RemoveAt
...
,î);ƫ.Ȳ(í,0);ú.Add(î,í);ß.v(î.Ø,î);ù.Add(C,î);}}ć++;}while(Ć<û.Д()){if(!ƫ.ʕ(300))return false;IMyTerminalBlock Ý=û.φ[Ć];
if(Ý==null)continue;if(!ü.φ.Contains(Ý)){ô(Ý);}Ć++;}û.Ů();û.Ж(ü);if(!ö.Ɏ&&ö.ϴ())ƫ.Ȳ(ö,0);return true;}public bool ă(string
Ă){if(string.Compare(Ă,"clear",true)==0){ö.ϻ();if(!ö.Ɏ)ƫ.Ȳ(ö,0);return true;}if(string.Compare(Ă,"boot",true)==0){ö.ϼ=0;
if(!ö.Ɏ)ƫ.Ȳ(ö,0);return true;}if(Ă.Ǹ("scroll")){τ ā=new τ(à,this,Ă);ƫ.Ȳ(ā,0);return true;}if(string.Compare(Ă,"props",true
)==0){Г Ā=à.ŋ;List<IMyTerminalBlock>Ñ=new List<IMyTerminalBlock>();List<ITerminalAction>Ƭ=new List<ITerminalAction>();
List<ITerminalProperty>ǒ=new List<ITerminalProperty>();IMyTextPanel ĳ=ƫ.Ǒ.GridTerminalSystem.GetBlockWithName("DEBUG")as
IMyTextPanel;if(ĳ==null){return true;}ĳ.WriteText("Properties: ");foreach(var k in Ā.Џ){ĳ.WriteText(k.Key+" =============="+"\n",
...
char>(2);public Ț ƫ;public Program Ǒ;public ȸ ǉ;public Г ŋ;public ʇ ǈ;public Ï Ʀ;public ǫ ğ;public IMyGridTerminalSystem Ǉ{
get{return Ǒ.GridTerminalSystem;}}public IMyProgrammableBlock ǆ{get{return Ǒ.Me;}}public Action<string>ǅ{get{return Ǒ.Echo;
}}public ɬ(Program Ǆ,int ǃ,Ț ƣ){ƫ=ƣ;ȥ=ǃ;Ǒ=Ǆ;ğ=new ǫ();ǉ=new ȸ(ƣ,this);ŋ=new Г(ƣ,this);ŋ.Ў();ǈ=new ʇ(ƫ);ƫ.Ȳ(ǈ,0);}Ѧ ǂ=null
;public string Ǔ{get{return ǂ.L;}}public bool Ǜ{get{return(ǂ.ŝ()==0);}}public bool ǚ(IMyTerminalBlock Ý){if(Ý==null||Ý.
WorldMatrix==MatrixD.Identity)return true;return Ǉ.GetBlockWithId(Ý.EntityId)==null;}public Ѧ Ǚ(Ѧ ǘ,á î){î.I();IMyTextSurface C=î.Õ
;if(ǘ==null)ǘ=new Ѧ(this);ǘ.L=C.Font;if(!ǐ.ContainsKey(ǘ.L))ǘ.L=ɝ;ǘ.ѥ=î.K()*(C.SurfaceSize.X/C.TextureSize.X)*Math.Max(
1.0f,C.TextureSize.X/C.TextureSize.Y)*ɡ/C.FontSize*(100f-C.TextPadding*2)/100;Ù=î.Ù;Ú=î.Ú;ǂ=ǘ;return ǘ;}public ş Ǘ(ş Þ,á î){
î.I();IMyTextSurface C=î.Õ;if(Þ==null)Þ=new ş(this);Þ.ű(î.Ô);Þ.Ũ=î.O()*(C.SurfaceSize.Y/C.TextureSize.Y)*Math.Max(1.0f,C.
TextureSize.Y/C.TextureSize.X)*ɠ/C.FontSize*(100f-C.TextPadding*2)/100;Þ.Ű();Ù=î.Ù;Ú=î.Ú;return Þ;}public void ǖ(){ǂ.ť();}public
void ǖ(ʐ Ť){if(ǂ.Ѥ<=0)ǂ.ÿ(Ù);ǂ.ÿ(Ť);ǂ.ť();}public void ǖ(string Ť){if(ǂ.Ѥ<=0)ǂ.ÿ(Ù);ǂ.ť(Ť);}public void Ǖ(string Š){ǂ.š(Š,Ù)
;}public void ǔ(List<ʐ>ŧ){ǂ.ţ(ŧ);}public void Ë(ʐ Ŧ,bool Ƽ=true){if(ǂ.Ѥ<=0)ǂ.ÿ(Ù);ǂ.ÿ(Ŧ);if(Ƽ)ǂ.Ѥ+=Ǩ(Ŧ,ǂ.L);}public void
Ë(string Ĵ,bool Ƽ=true){if(ǂ.Ѥ<=0)ǂ.ÿ(Ù);ǂ.ÿ(Ĵ);if(Ƽ)ǂ.Ѥ+=Ǩ(Ĵ,ǂ.L);}public void Ƶ(ʐ Ŧ,float Ʊ=1.0f,float ư=0f){Ʋ(Ŧ,Ʊ,ư);ǂ
.ť();}public void Ƶ(string Ĵ,float Ʊ=1.0f,float ư=0f){Ʋ(Ĵ,Ʊ,ư);ǂ.ť();}ʐ ƴ=new ʐ();public void Ʋ(ʐ Ŧ,float Ʊ=1.0f,float ư=
0f){float Ư=Ǩ(Ŧ,ǂ.L);float Ʈ=Ʊ*ɨ*ǂ.ѥ-ǂ.Ѥ-ư;if(Ú>0)Ʈ-=2*ǐ[ǂ.L]*Ú;if(Ʈ<Ư){ǂ.ÿ(Ŧ);ǂ.Ѥ+=Ư;return;}Ʈ-=Ư;int ƭ=(int)Math.Floor(Ʈ
/ǐ[ǂ.L]);float Ƴ=ƭ*ǐ[ǂ.L];ƴ.Ů().ɱ(' ',ƭ).ɱ(Ŧ);ǂ.ÿ(ƴ);ǂ.Ѥ+=Ƴ+Ư;}public void Ʋ(string Ĵ,float Ʊ=1.0f,float ư=0f){float Ư=Ǩ(
Ĵ,ǂ.L);float Ʈ=Ʊ*ɨ*ǂ.ѥ-ǂ.Ѥ-ư;if(Ú>0)Ʈ-=2*ǐ[ǂ.L]*Ú;if(Ʈ<Ư){ǂ.ÿ(Ĵ);ǂ.Ѥ+=Ư;return;}Ʈ-=Ư;int ƭ=(int)Math.Floor(Ʈ/ǐ[ǂ.L]);
float Ƴ=ƭ*ǐ[ǂ.L];ƴ.Ů().ɱ(' ',ƭ).ɱ(Ĵ);ǂ.ÿ(ƴ);ǂ.Ѥ+=Ƴ+Ư;}public void ƶ(ʐ Ŧ){ǀ(Ŧ);ǂ.ť();}public void ƶ(string Ĵ){ǀ(Ĵ);ǂ.ť();}
public void ǀ(ʐ Ŧ){float Ư=Ǩ(Ŧ,ǂ.L);float ǁ=ɨ/2*ǂ.ѥ-ǂ.Ѥ;if(ǁ<Ư/2){ǂ.ÿ(Ŧ);ǂ.Ѥ+=Ư;return;}ǁ-=Ư/2;int ƭ=(int)Math.Round(ǁ/ǐ[ǂ.L],
MidpointRounding.AwayFromZero);float Ƴ=ƭ*ǐ[ǂ.L];ƴ.Ů().ɱ(' ',ƭ).ɱ(Ŧ);ǂ.ÿ(ƴ);ǂ.Ѥ+=Ƴ+Ư;}public void ǀ(string Ĵ){float Ư=Ǩ(Ĵ,ǂ.L);float ǁ=ɨ/
2*ǂ.ѥ-ǂ.Ѥ;if(ǁ<Ư/2){ǂ.ÿ(Ĵ);ǂ.Ѥ+=Ư;return;}ǁ-=Ư/2;int ƭ=(int)Math.Round(ǁ/ǐ[ǂ.L],MidpointRounding.AwayFromZero);float Ƴ=ƭ*
ǐ[ǂ.L];ƴ.Ů().ɱ(' ',ƭ).ɱ(Ĵ);ǂ.ÿ(ƴ);ǂ.Ѥ+=Ƴ+Ư;}public void ƿ(double ƾ,float ƽ=1.0f,float ư=0f,bool Ƽ=true){if(Ú>0)ư+=2*Ú*ǐ[ǂ
.L];float ƻ=ɨ*ƽ*ǂ.ѥ-ǂ.Ѥ-ư;if(Double.IsNaN(ƾ))ƾ=0;int ƺ=(int)(ƻ/Ǐ[ǂ.L])-2;if(ƺ<=0)ƺ=2;int ƹ=Math.Min((int)(ƾ*ƺ)/100,ƺ);if(
ƹ<0)ƹ=0;if(ǂ.Ѥ<=0)ǂ.ÿ(Ù);ƴ.Ů().ɱ(Ǎ[ǂ.L]).ɱ(Ǌ[ǂ.L],ƹ).ɱ(ǋ[ǂ.L],ƺ-ƹ).ɱ(ǌ[ǂ.L]);ǂ.ÿ(ƴ);if(Ƽ)ǂ.Ѥ+=Ǐ[ǂ.L]*ƺ+2*ǎ[ǂ.L];}public
void Ƹ(double ƾ,float ƽ=1.0f,float ư=0f){ƿ(ƾ,ƽ,ư,false);ǂ.ť();}public void Ş(){ǂ.Ş();}public void Ȃ(á o,ş D=null){o.E(D);if(
o.Ö)o.Þ.Ķ();}public void ȁ(string Ȁ,string Ĵ){IMyTextPanel o=Ǒ.GridTerminalSystem.GetBlockWithName(Ȁ)as IMyTextPanel;if(o
==null)return;o.WriteText(Ĵ+"\n",true);}public string ǿ(MyInventoryItem k){string Ǿ=k.Type.TypeId.ToString();Ǿ=Ǿ.Substring
(Ǿ.LastIndexOf('_')+1);return k.Type.SubtypeId+" "+Ǿ;}public void ȃ(string Å,out string Ã,out string Â){int ļ=Å.
LastIndexOf(' ');if(ļ>=0){Ã=Å.Substring(0,ļ);Â=Å.Substring(ļ+1);return;}Ã=Å;Â="";}public string ǽ(string Å){string Ã,Â;ȃ(Å,out Ã,
out Â);return ǽ(Ã,Â);}public string ǽ(string Ã,string Â){È k=Ʀ.Ä(Ã,Â);if(k!=null){if(k.é.Length>0)return k.é;return k.Á;}
return System.Text.RegularExpressions.Regex.Replace(Ã,"([a-z])([A-Z])","$1 $2");}public void Ǽ(ref string Ã,ref string Â){È k;
if(Ʀ.Ì.TryGetValue(Ã,out k)){Ã=k.Á;Â=k.Ò;return;}k=Ʀ.Ä(Ã,Â);if(k!=null){Ã=k.Á;if(string.IsNullOrEmpty(Â)&&(string.Compare(
k.Ò,"Ore",true)==0)||(string.Compare(k.Ò,"Ingot",true)==0))return;Â=k.Ò;}}public string Ȑ(double Ȏ,bool ȍ=true,char Ȍ=' '
){if(!ȍ)return Ȏ.ToString("#,###,###,###,###,###,###,###,###,###");string ȋ=" kMGTPEZY";double Ȋ=Ȏ;int ȉ=ȋ.IndexOf(Ȍ);var
Ȉ=(ȉ<0?0:ȉ);while(Ȋ>=1000&&Ȉ+1<ȋ.Length){Ȋ/=1000;Ȉ++;}ƴ.Ů().ɱ(Math.Round(Ȋ,1,MidpointRounding.AwayFromZero));if(Ȉ>0)ƴ.ɱ(
